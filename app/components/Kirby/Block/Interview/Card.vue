  ...
  <NuxtLink :to="fullPath">
    ...
    >
      <div class="aspect-[4/6] overflow-hidden">
        ...
        <div
          class="pointer-events-none absolute top-0 right-0 w-1/2 h-1/2 z-10 gradient-topright-bl"
        />
      </div>
      ...
      <div class="absolute bottom-0 left-0 right-0 px-4 pb-3">
        <h3
          class="text-white font-serif text-base font-bold italic quote-text -mb-2"
          :style="{
        ...
        />
        <div
          class="text-small text-white opacity-75"
          :style="{
